					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
							  ...
							  <li><a href="#"><em class="fa fa-envelope"></em> k142184@nu.edu.pk</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="https://www.facebook.com/muhammadrazabhojani?fref=ts"><i class="fa fa-facebook"></i> Raza</a></li>
...
<div class="col-sm-4">
 ...
 <?php 							echo '<img src="data:image/jpeg;base64,'.base64_encode( $result1['image'] ).'"   width="100" height="198" />';?> 
